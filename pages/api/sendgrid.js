...
sendgrid.setApiKey(process.env.customKey);

async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "olingomaxwell1999@gmail.com", // Your email where you'll receive emails
      from: "maxwellolingo8@gmail.com", // your website email address here
